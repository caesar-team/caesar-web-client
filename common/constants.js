...
export const CHECK_MASTER_PASSWORD_FLOW = 'CHECK_MASTER_PASSWORD_FLOW';
export const CREATE_MASTER_PASSWORD_FLOW = 'CREATE_MASTER_PASSWORD_FLOW';
export const SHARED_FLOW = 'SHARED_FLOW';
